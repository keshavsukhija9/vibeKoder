...
export default function ProjectTable({
  ...
  return (
    <>
      <div className="rounded-2xl border border-[var(--vibe-border)] bg-[var(--vibe-surface)] overflow-hidden shadow-[var(--vibe-shadow)]">
        <Table>
          <TableHeader>
            <TableRow>
            ...
            {projects.map((project) => (
              <TableRow key={project.id}>
                ...
                <TableCell>
                  <Badge
                    variant="outline"
                    className="bg-[var(--vibe-primary)]/10 text-[var(--vibe-primary)] border-[var(--vibe-primary)]/30"
                  >
                    {project.template}
                  </Badge>
                </TableCell>
